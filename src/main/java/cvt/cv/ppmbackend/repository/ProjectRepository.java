...
public interface ProjectRepository extends JpaRepository<Project,java.util.UUID>{
 List<Project> findByStatus(ProjectStatus status); List<Project> findByDomainId(java.util.UUID domainId);
 List<Project> findByProgramId(java.util.UUID programId); List<Project> findByRiskStatus(ExecutiveStatus riskStatus);
